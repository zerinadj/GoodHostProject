...
namespace GoodHost.EntityFramework
{
    ...
    public class GoodHostDbContext : AbpZeroDbContext<Tenant, Role, User>
    {
        ...
        /* NOTE:
         *   This constructor is used by ABP to pass connection string defined in GoodHostDataModule.PreInitialize.
         *   Notice that, actually you will not directly create an instance of GoodHostDbContext since ABP automatically handles it.
         */
        public GoodHostDbContext(string nameOrConnectionString)
        ...
        public GoodHostDbContext(DbConnection existingConnection, bool contextOwnsConnection)
